    ...
    <div class="validators-container">
      <div class="filters">
        <div class="search-bar">
          <input type="text" placeholder="Search Operators..." v-model="searchQuery" @input="debounceSearch" />
        </div>
      ...
      <div class="table-container">
        <div class="validators-table">
          ...
          <template v-else>
            <div v-for="(validator, index) in filteredValidators" :key="validator.address" class="validator-row">
              ...
              <div class="col-delegators">
                <a 
                  :href="'https://suiscan.xyz/mainnet/object/'+validator.address" 
                  target="_blank" 
        ...
        <div class="pagination" v-if="totalPages > 1">
          <button class="page-btn prev" :disabled="currentPage === 0" @click="changePage(currentPage - 1)">
            &laquo; Previous
          </button>
          ...
          <button class="page-btn next" :disabled="currentPage >= totalPages - 1" @click="changePage(currentPage + 1)">
            next &raquo;
          </button>
        </div>
      </div>
  ...
  methods: {
    ...
    async copyToClipboard(text) {
      try {
        ...
        this.showToastMessage('Failed to copy address', 'error');
      }
    },
